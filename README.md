...
- Milvus *Vector Database* [Site](https://milvus.io/) - [GitHub](https://github.com/milvus-io/milvus)
- MongoDB *OLTP, Unstructured* [Site](https://www.mongodb.com/) - [GitHub](https://github.com/mongodb/mongo)
- MySQL [Site](https://www.mysql.com/) - [GitHub](https://github.com/mysql/mysql-server)
- Neo4j *Graph Database* [Site](https://neo4j.com/) - [Github](https://github.com/neo4j)
- OpenSearch *Search Engine* [Site](https://www.opensearch.org/) - [GitHub](https://github.com/opensearch-project/opensearch)
- Pinecone *Vector Datbase* [Site](https://www.pinecone.io/) - [GitHub](https://github.com/pinecone-io)
...
- Dioxus [Site](https://dioxuslabs.com/) - [GitHub](https://github.com/dioxuslabs/dioxus)
  - Rust -> Fullstack app framework for Web, Desktop, and Mobile
...
- Ray *Runtime and set of libraries for ML acceleration - Anyscale* [Site](https://docs.ray.io/en/latest/#) - [GitHub](https://github.com/ray-project)
